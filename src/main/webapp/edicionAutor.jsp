            ...
            <input type="hidden" name="id" value="<%=autor.getId()%>">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" value="<%=autor.getNombre() !=null? autor.getNombre(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apPaterno" id="apPaterno" class="form-control" value="<%=autor.getApPaterno() !=null? autor.getApPaterno(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="apMaterno" id="ApMaterno" class="form-control" value="<%=autor.getApMaterno() !=null? autor.getApMaterno(): ""%>">
                        <%
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="descripcion" id="descripcion" class="form-control" value="<%=autor.getDescripcion() !=null? autor.getDescripcion(): ""%>">
                        <%
