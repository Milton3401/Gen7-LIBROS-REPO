...
@WebServlet("/responsables/detalle")
public class DetalleResponsableServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(id >0){
            ...
            if(o.isPresent()){
                ...
                getServletContext().getRequestDispatcher("/detalleResponsable.jsp")
                        .forward(req,resp);
            }
            else {
            ...
            resp.sendRedirect(req.getContextPath()+"/resposables/lista");
            resp.sendError(HttpServletResponse.SC_NOT_FOUND,
